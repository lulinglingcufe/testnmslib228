...
data_matrix = all_data_matrix[0:10000]#800100   1000000 
print('Load data\n')
...
#'indexThreadQty': num_threads, 'post' : 0
#index_time_params = {'alphaLeft': 2.0, 'alphaRight': 2.0, 'expLeft': 1, 'expRight': 1,'maxLeavesToVisit': 500, 'indexThreadQty': num_threads, 'post' : 0}
